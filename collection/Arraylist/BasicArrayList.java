...
public class BasicArrayList {
    public static void main(String[] args) {
        ...
        ArrayList<Integer> list = new ArrayList<Integer>(); // size is not mandatory
        // ArrayList<Integer> List =new  ArrayList<>(5);    //same
        ...
        // size of arraylist -->syntax:objectName.size();--> list.size(); ----> equivalent in array:  arr.length;
